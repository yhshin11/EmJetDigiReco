...
# with command line options: step12 --filein file:input.root --fileout file:aodsim.root --pileup_input dbs:/MinBias_TuneCUETP8M1_13TeV-pythia8/RunIISummer15GS-MCRUN2_71_V1-v2/GEN-SIM --mc --eventcontent RAWSIM --pileup 2016_25ns_SpringMC_PUScenarioV1_PoissonOOTPU --datatier GEN-SIM-RAW --conditions 80X_mcRun2_asymptotic_2016_v3 --step DIGI,L1,DIGI2RAW,HLT:@frozen25ns --era Run2_25ns --python_filename aodsim_RunIISpring16DR80_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 30
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step12 nevts:30'),
